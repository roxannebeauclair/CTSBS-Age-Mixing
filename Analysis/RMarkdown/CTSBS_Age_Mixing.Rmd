...
```{r page_at_50, include = FALSE, warning = FALSE}
# formula for calculating average partner age
# page = B-Age * (Age) + Intercept

# HNM
pagehnm40 <- round((slopeintci$mean[7] * 40) + slopeintci$mean[3])

# HNW
pagehnw40 <- round((slopeintci$mean[5] * 40) + slopeintci$mean[1])

# HPW
pagehpw40 <- round((slopeintci$mean[6] * 40) + slopeintci$mean[2])

# HPM
pagehpm40 <- round((slopeintci$mean[8] * 40) + slopeintci$mean[4])
