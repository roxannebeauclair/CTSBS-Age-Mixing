...
###### **Figure 2. Distribution of age-mixing model slopes for 50 imputed datasets, each bootstraped 1000 times.**
...
###### **Figure 3. Distribution of age-mixing model intercepts for 50 imputed datasets, each bootstraped 1000 times.**
...
###### **Figure 4. Distribution of age-mixing within-subject standard deviations (wsd) for 50 imputed datasets, each bootstraped 1000 times.**

<br>

The average difference between: 

* Male and female wsd in the HIV negative population: `r wvardifci$meangendifneg` (95% CI: `r wvardifci$lwrgendifneg` - `r wvardifci$uprgendifneg`)
* Male and female wsd in the HIV positive population: `r wvardifci$meangendifpos` (95% CI: `r wvardifci$lwrgendifpos` - `r wvardifci$uprgendifpos`)
* HIV positive and negative wsd in the male population: `r wvardifci$meanhivdifmale` (95% CI: `r wvardifci$lwrhivdifmale` - `r wvardifci$uprhivdifmale`)
* HIV positive and negative wsd in the female population: `r wvardifci$meanhivdiffemale` (95% CI: `r wvardifci$lwrhivdiffemale` - `r wvardifci$uprhivdiffemale`)
...
###### **Figure 5. Distribution of age-mixing between-subject standard deviations (bsd) for 50 imputed datasets, each bootstraped 1000 times.**
