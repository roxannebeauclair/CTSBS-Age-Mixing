...
Here I used linear mixed effects models that were stratified by sex and hiv status and contained a random intercept for the participant. For the plots, I randomly selected an imputed dataset to visualize the pattern in that population. Heteroskedastic variance is now taken into account in the models that produced these predictions.
...
###### **Figure 1. Age mixing pattern for randomly selected imputed dataset.**
...
###### **Figure 6. Distribution of age-mixing power coefficient for 50 imputed datasets, each bootstraped 10 times. The models for HIV positive women did not explicitly model heteroskedastic variance**

<br>

The average difference between: 

* Male and female bsd in the HIV negative population was `r powerdifci$meangendifneg` (95% CI: `r powerdifci$lwrgendifneg` - `r powerdifci$uprgendifneg`)
* HIV positive and negative bsd in the male population was `r powerdifci$meanhivdifmale` (95% CI: `r powerdifci$lwrhivdifmale` - `r powerdifci$uprhivdifmale`)
...
###### **Figure 7. Distribution of bridge widths for each imputed dataset, by sex and HIV status.**
...
###### **Figure 8. Distribution of bridge widths for each imputed dataset, by sex and agegroup.**
...
###### **Figure 9. Model coefficients for relationship between HIV and bridgewidth.**
...
###### **Figure 10. Expected bridge widths for different values of age (smooth term), by gender.**
