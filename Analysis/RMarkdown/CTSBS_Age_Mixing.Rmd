...
# WSVar(age) = WSVar(baseline) * (1+age_above_baseline)^PowerCoeff
...
difwvarsum <- wvardif %>%
  mutate(gendifneg = Female_Negative_wsd - Male_Negative_wsd, # Ha: Female wvar larger than males
         gendifpos = Female_Positive_wsd - Male_Positive_wsd, # Ha; Female wvar larger than males
         hivdifmale = Male_Positive_wsd - Male_Negative_wsd, # Ha: Pos wvar larger than neg
         hivdiffemale = Female_Positive_wsd - Female_Negative_wsd, # Ha: Pos wvar larger than neg
