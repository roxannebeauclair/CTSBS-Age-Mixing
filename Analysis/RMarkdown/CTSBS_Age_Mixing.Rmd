...
###### **Figure 12. Effect of HIV on condom use (Never or Infrequently vs Always) in relationship, stratified by gender. Beta-coefficients are from generalized additive mixed models (logistic outcome) with a random intercept for the participant. Models are adjusted for age, agegaps (hypothetical mediator) and race.**
